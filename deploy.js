...
console.log('🚀 Starting PRODUCTION Deployment to meditrack-portal.surge.sh...');
...
const deployResult = spawnSync('npx.cmd', ['surge', 'dist', domain], { stdio: 'inherit', shell: true });

if (deployResult.status === 0) {
  console.log('✅ Successfully deployed web app to PRODUCTION: https://' + domain);
} else {
  console.error('❌ Deployment failed with status code ' + deployResult.status);
